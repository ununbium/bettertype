 ...
 * it is up to the ThrowableConverter to handle the failure value generation.
 *
 * NullValueAbsorbed is never thrown. It is only ever passed to the ThrowableConverter in the event that the
 ...
 * ability to define the ThrowableConverter inline as a function.
 */
